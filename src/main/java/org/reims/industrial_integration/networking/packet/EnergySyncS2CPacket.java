package org.reims.industrial_integration.networking.packet;
...
public class EnergySyncS2CPacket {
    ...
    public boolean handle(Supplier<NetworkEvent.Context> supplier) {
        ...
        context.enqueueWork(() -> {
            if(Minecraft.getInstance().level.getBlockEntity(pos) instanceof AbstractMachineWithEnergyBlockEntity blockEntity) {
